...
def ARO_DBSCAN(dim,max_it, npop,trainX, testX, trainy, testy , pop_pos_init, pop_fit_init,best_pop_init,best_fit_init,best_acc_init,best_cols_init,roound):
    ...
    for it in range(max_it-1):
        print('ARO-DBSCAN,Itration : '+str(roound) +'-'+str(it)+'  Fitness: '+str(best_f)+'  Acc: '+str(best_acc)+
